  ...
  return (
    <div style={{ backgroundColor: "black", height: "100vh", color: "white" }}>
      <style>
        {`
          ...
          .wheel-and-hamster {
            ...
            font-size: 14px;
            margin: 0 auto;
            top: 20%; /* Adjust top to center the hamster vertically */
          }
      ...
      <div
        ...
        role="img"
        className="wheel-and-hamster mx-auto bg mt-[20%]"
      >
      ...
      <div className="absolute bottom-20 left-0 right-0 text-3xl text-center text-white">
