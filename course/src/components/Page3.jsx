...
function Page3({ mode }) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = scrollYProgress.onChange((latest) => {
      setPercent(latest * 100); // Convert scroll progress to percentage
    });
  ...
  return (
    <>
      ...
      >
        <div className="absolute  z-30 flex-col font-serif justify-between items-center">
        ...
        <motion.div
          ...
          className="w-[40vh] md:w-[80vh] z-20 h-[80vh] md:h-[80vh] bg-[#1f1d1dff] rounded-full"
        ></motion.div>
